...
def addTask():
    ...
    if task:
        with open("tasklist.txt",'a', encoding = 'utf-8', errors='ignore') as taskfile:
            taskfile.write(f"\n{task}\n")
...
heading=Label (root,text="ALL TASKS",font=("Arial Unicode MS", 20, "bold"),fg="white",bg="#32405b", anchor="e")
heading.place(x=122, y=20)
...
task=StringVar()
task_entry=Entry(frame,width=18, font=("Arial Unicode MS", 20), bd=0, justify="right")
...
listbox= Listbox(frame1, font=('Arial Unicode MS' ,12), width=40,height=16,bg="#32405b", fg="white", cursor="hand2", selectbackground="#5a95ff")
